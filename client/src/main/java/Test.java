...
public class Test {
    ...
    public StompSession connect(String username, String password) {
    ...
    public void subscribeOnMessage(StompSession stompSession) throws ExecutionException, InterruptedException {
        stompSession.subscribe("/message.new/t1", new StompFrameHandler() {
